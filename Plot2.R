...
plot(plotDF[,2],plotDF[,3], type="l",xlab="", ylab="Global Active Power (kilowatts)")
# axisDates <- c("02-01-2007 00:00:00", "02-02-2007 00:00:00","02-02-2007 23:59:59" )
# axisPoints <- as.POSIXct(axisDates, "%m-%d-%Y %H:%M:%S")
# atpts <- as.numeric(axisPoints)
# axis(1,at=atpts, labels=c("Thu", "Fri", "Sat"))
dev.off()